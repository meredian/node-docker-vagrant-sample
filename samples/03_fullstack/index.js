...
// Hostname 'redis' will be added to container's /etc/hosts and will be recognized by server
var redisHost = (process.env.NODE_ENV === 'docker') ? "redis" : "127.0.0.1";

app.redis = redis.createClient(6379, redisHost);
